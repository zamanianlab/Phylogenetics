...
species=Phylogenetics/Thermoreceptors/parasite.list.txt
...
# add human proteome
mv Phylogenetics/Thermoreceptors/HsUniProt_nr.fasta $proteomes
...
# copy Ce and Hs list files (Thermoreceptors seq ids)
mv Phylogenetics/Thermoreceptors/Ce_Thermoreceptors.list.txt $Ce_seeds
...
done < Phylogenetics/Thermoreceptors/parasite_db.list.txt
