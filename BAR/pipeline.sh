...
wbp_prefix="ftp.ebi.ac.uk/pub/databases/wormbase/parasite/releases/current/species/"
...
seqtk subseq $proteomes/caenorhabditis_elegans.PRJNA13758.WBPS16.protein.fa $Ce_seeds/Ce_BARs.list.txt > $Ce_seeds/Ce_seed."$line_sub".fasta
