...
species=Phylogenetics/btubulin/parasite.list.txt
...
# copy Ce and Hs list files (DOP seq ids)
mv Phylogenetics/btubulin/Ce_seed.list.txt $Ce_seeds

# get sequences of seeds
seqtk subseq $proteomes/caenorhabditis_elegans.PRJNA13758.WBPS19.protein.fa $Ce_seeds/Ce_seed.list.txt > $Ce_seeds/Ce_seed."$line_sub".fasta
...
done < Phylogenetics/btubulin/parasite_db.list.txt
