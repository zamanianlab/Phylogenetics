...
species=Phylogenetics/DOP/parasite.list.txt
...
# add human proteome
mv Phylogenetics/DOP/HsUniProt_nr.fasta $proteomes
...
mv Phylogenetics/DOP/Ce_DOP.list.txt $Ce_seeds
mv Phylogenetics/DOP/Hs_DOP.list.txt $Hs_seeds

# get sequences of seeds
seqtk subseq $proteomes/caenorhabditis_elegans.PRJNA13758.WBPS18.protein.fa $Ce_seeds/Ce_DOP.list.txt > $Ce_seeds/Ce_seed."$line_sub".fasta
seqtk subseq $proteomes/HsUniProt_nr.fasta $Hs_seeds/Hs_DOP.list.txt > $Hs_seeds/Hs_seed."$line_sub".fasta
...
done < Phylogenetics/DOP/parasite_db.list.txt
